...
## 4. Заполнить конфигурацию Hysteria 2
...
Замените содержимое на пример ниже. Значения в угловых скобках возьмите из своего подключения `hysteria2://...`. В публичный репозиторий и сообщения об ошибках пароли не вставляйте.
